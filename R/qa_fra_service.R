#' Get quality assurance flow rate audit data at
#' a site.
#' 
#' @export
...
#' Get quality assurance flow rate audit data for a primary quality assurance
#' organization.
#' @export
#' @param bdate Beginning date to check.
#' Year, month, day format.
...
#' Get quality assurance flow rate audit data for a 
#' monitoring agency.
#' @export
#' @param bdate Beginning date to check.
#' Year, month, day format.
