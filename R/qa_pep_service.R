...
#' result$Data
#' } 
get_qa_pep_in_site <- function(bdate, edate, state.fips, county, param, site){
...
#' result$Data
#' }
get_qa_pep_in_county <- function(bdate, edate, state.fips, county, param){
...
#' result$Data
#' }
get_qa_pep_in_state <- function(bdate, edate, state.fips, param){
...
#' result$Data
#' }
get_qa_pep_in_pqao <- function(bdate, edate, param, pqao){
