...
At this point, we can place the URL in the browser and retrieve data about states. Most data, however,
will probably involve a particular pollutant in a desired region. In that case, we must also add additional variables to the url string. 
...
tedious. This package aims to simplify making these urls and using them to retrieve data. 
