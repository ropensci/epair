httptest::with_mock_dir("qa_ape_in_site_ok", {
...
httptest::with_mock_dir("qa_ape_in_county_ok", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20201231"
        state.fips <- "01"
...
httptest::with_mock_dir("qa_ape_in_state_ok", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20201231"
        state.fips <- "01"
...
httptest::with_mock_dir("qa_ape_in_pqao_ok", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20201231"
        pqao <- "0013"
...
httptest::with_mock_dir("qa_ape_in_agency_ok", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20201231"
        param <- "44201"
