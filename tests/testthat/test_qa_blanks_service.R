httptest::with_mock_dir("get_qa_blanks_in_site() is OK", {
...
httptest::with_mock_dir("get_qa_blanks_in_county() is OK", {
    test_that("Status returns successful", {
        bdate <- "20180101"
        edate <- "20180131"
        state.fips <- "01"
...
httptest::with_mock_dir("get_qa_blanks_in_state() is OK", {
    test_that("Status returns successful", {
        bdate <- "20180101"
        edate <- "20180131"
        state.fips <- "01"
...
httptest::with_mock_dir("get_qa_blanks_in_pqao() is OK", {
    test_that("Status returns successful", {
        bdate <- "20180101"
        edate <- "20180131"
        param <- "88101"
...
httptest::with_mock_dir("get_qa_blanks_in_agency() is OK", {
    test_that("Status returns successful", {
        bdate <- "20180101"
        edate <- "20180131"
        param <- "88101"
