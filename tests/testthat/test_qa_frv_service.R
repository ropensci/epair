httptest::with_mock_dir("get_qa_frv_in_site() is OK", {
...
httptest::with_mock_dir("get_qa_frv_in_county() is OK", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20200131"
        state.fips <- "01"
...
httptest::with_mock_dir("get_qa_frv_in_state() is OK", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20200131"
        state.fips <- "01"
...
httptest::with_mock_dir("get_qa_frv_in_pqao() is OK", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20200131"
        param <- "88101"
...
httptest::with_mock_dir("get_qa_frv_in_agency() is OK", {
    test_that("Status returns successful", {
        bdate <- "20200101"
        edate <- "20200131"
        param <- "88101"
